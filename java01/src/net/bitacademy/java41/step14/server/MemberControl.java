...
import net.bitacademy.java41.step14.Member;

public class MemberControl {
	private Member member;
	private MemberDao memberDao;
	
	public MemberControl(MemberDao memberDao) {
	...
	private void view(Scanner scanner, PrintStream out, String email) {
		try {
